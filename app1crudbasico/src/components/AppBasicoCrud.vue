                ...
                <div>
                    <div class="list-group">
                      <!--ArrayIteracao e uma variável que recebe o valor do array de cada iteração-->
                        ...
                        v-for="ArrayIteracao, index in comentarios" v-bind:key="ArrayIteracao">
                            <span class="coment_autor">Nome: {{ArrayIteracao.nome}} 
                                <p>Comentário:{{ArrayIteracao.msm}}</p>
                                
                                </span>
                                <div>
                                  <!--Adiciona o index como parametros para saber a posição de iteração-->
                                  <button class="btn btn-danger" v-on:click.prevent="removeComentarios(index)">Excluir</button>
                                  <button class="btn btn-primary" v-on:click.prevent="atualizarComentarios(index)">Atualizar</button>
                                </div>
